...
(function($){
    ...
    $('#chartjs_chart_type').imagepicker({ show_label: true });

    $( "#chart-container-tabs" ).tabs().addClass( "ui-tabs-vertical ui-helper-clearfix" );
    ...
    $('#nextStep').click(function(e){
        ...
        switch( curStep ){
            case 'step1':
                ...
                if( $('#chart_render_engine').val() == 'google' ){
                ...
                } else if( $('#chart_render_engine').val() == 'chartjs' ){

                    $( "#googleChartContainer" ).hide();
                    ...
                    constructedChartData.chart_type = $('#chartjs_chart_type').val();
                    switch (constructedChartData.chart_type) {
                    ...
                    constructedChartData.min_columns = parseInt( $('#chartjs_chart_type option:selected').data('min_columns') );
                    constructedChartData.max_columns = parseInt( $('#chartjs_chart_type option:selected').data('max_columns') );
                }
            ...
            case 'step3':
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        $('div.chartWizardStep.step4').show();
                        ...
                        if (constructedChartData.engine == 'google') {
                            if( typeof editing_chart_data != 'undefined'){
                                for (i in editing_chart_data.render_data.options.series) {
                                    $('#series_settings_container div.chart_series_block:eq(' + i + ')').find('div.chart_series_color input').val(editing_chart_data.render_data.options.series[i].color);
                                ...
                                for (i in data.series) {
                                    $('#series_settings_container div.chart_series_block:eq(' + i + ')').find('div.chart_series_color input').val(data.series[i].color);
                                }
                            }
                        } else if (constructedChartData.engine == 'highcharts') {
                            if( typeof editing_chart_data != 'undefined'){
                                for (i in editing_chart_data.highcharts_render_data.options.series) {
                                    $('#series_settings_container div.chart_series_block:eq(' + i + ')').find('div.chart_series_color input').val(editing_chart_data.highcharts_render_data.options.series[i].color);
                            ...
                            if( typeof editing_chart_data != 'undefined'){
                                for (i in editing_chart_data.chartjs_render_data.options.data.datasets) {
                                    $('#series_settings_container div.chart_series_block:eq(' + i + ')').find('div.chart_series_color input').val(editing_chart_data.chartjs_render_data.options.data.datasets[i].borderColor);
                                ...
                                for (i in data.options.data.datasets) {
                                    $('#series_settings_container div.chart_series_block:eq(' + i + ')').find('div.chart_series_color input').val(data.options.data.datasets[i].borderColor);
                                }
                            }
                        }
                        ...
                        $('#font_color_container input.font_color').wpColorPicker();
                        // Title
                        $('#title_font_color_container input.title_font_color').wpColorPicker();
                        // Tooltip
                        ...
                        if (constructedChartData.engine == 'google') {
                            ...
                            var container = document.getElementById("chartJSContainer");
                            var canvas = document.getElementById("chartJSCanvas");
                        ...
                        $('#series_settings_container input.series_color,' +
                          '#background_color_container input.background_color,' +
                          '#border_color_container input.border_color,' +
                          '#plot_background_color_container input.plot_background_color,' +
                          '#plot_border_color_container input.plot_border_color,' +
                          '#font_color_container input.font_color,' +
                          '#title_font_color_container input.title_font_color,' +
                          '#tooltip_background_color_container input.tooltip_background_color,' +
                          '#tooltip_border_color_container input.tooltip_border_color,' +
                          '#legend_background_color_container input.legend_background_color,' +
                          '#legend_border_color_container input.legend_border_color,' +
                          '#exporting_button_color_container input.exporting_button_color'
                        ).wpColorPicker({
                        ...
                        $('div.step4 input:not(#group_chart), div.step4 select')
                            .on('change', function () {
                                renderChart(false);
                            });
    ...
    function getInputData(){
        ...
        constructedChartData.border_width = parseInt( $('#border_width').val() );
        ...
        constructedChartData.font_style = $('#font_style').val();
        constructedChartData.font_color = $('input.font_color').val();
        ...
        constructedChartData.title_position = $('#title_position').val();
        constructedChartData.title_font_size = $('#title_font_size').val();
        constructedChartData.title_font_name = $('#title_font_name').val();
        constructedChartData.title_font_style = $('#title_font_style').val();
        constructedChartData.title_font_color = $('input.title_font_color').val();
        ...
        constructedChartData.legend_position_cjs = $('#legend_position_cjs').val();
    ...
    $(document).ready(function(){
        if( $('#wpDataChartId').val() != '' ){
            ...
            if( editing_chart_data.engine == 'google' ){
                ...
                $('#chartjs_chart_type').val( editing_chart_data.type ).change()
            }
            ...
            if (editing_chart_data.engine == 'google') {
                ...
                if (editing_chart_data.render_data.options.curveType == 'none'){
                    $('#curve_type').prop('checked','');
                } else {
                    $('#curve_type').prop('checked','checked');
                }
                ...
                // Chart
                $('input.background_color').val(editing_chart_data.chartjs_render_data.configurations.canvas.backgroundColor);
                $('#border_width').val(editing_chart_data.chartjs_render_data.configurations.canvas.borderWidth);
                $('input.border_color').val(editing_chart_data.chartjs_render_data.configurations.canvas.borderColor);
                $('#border_radius').val(editing_chart_data.chartjs_render_data.configurations.canvas.borderRadius);
                if (editing_chart_data.chartjs_render_data.options.globalOptions.defaultFontSize == null) {
                    $('#font_size').val('');
                } else {
                    $('#font_size').val(editing_chart_data.chartjs_render_data.options.globalOptions.defaultFontSize);
                }
                $('#font_name').val(editing_chart_data.chartjs_render_data.options.globalOptions.defaultFontFamily);
                $('#font_style').val(editing_chart_data.chartjs_render_data.options.globalOptions.defaultFontStyle);
                $('input.font_color').val(editing_chart_data.chartjs_render_data.options.globalOptions.defaultFontColor);
                ...
                // Axes
                $('#horizontal_axis_label').val(editing_chart_data.chartjs_render_data.options.options.scales.xAxes[0].scaleLabel.labelString);
                $('#vertical_axis_label').val(editing_chart_data.chartjs_render_data.options.options.scales.yAxes[0].scaleLabel.labelString);
                $('#vertical_axis_min').val(editing_chart_data.chartjs_render_data.options.options.scales.yAxes[0].ticks.min);
                $('#vertical_axis_max').val(editing_chart_data.chartjs_render_data.options.options.scales.yAxes[0].ticks.max);

                // Title
                $('#title_position').val(editing_chart_data.chartjs_render_data.options.options.title.position);
                $('#title_font_name').val(editing_chart_data.chartjs_render_data.options.options.title.fontFamily);
                $('#title_font_style').val(editing_chart_data.chartjs_render_data.options.options.title.fontStyle);
                $('input.title_font_color').val(editing_chart_data.chartjs_render_data.options.options.title.fontColor);
                ...
                $('input.tooltip_background_color').val(editing_chart_data.chartjs_render_data.options.options.tooltips.backgroundColor);
                $('#tooltip_border_radius').val(editing_chart_data.chartjs_render_data.options.options.tooltips.cornerRadius);
                ...
                $('#legend_position_cjs').val(editing_chart_data.chartjs_render_data.options.options.legend.position);
