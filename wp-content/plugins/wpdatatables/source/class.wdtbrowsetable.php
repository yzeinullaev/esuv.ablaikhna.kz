...
class WDTBrowseTable extends WP_List_Table {
    ...
    function column_default($item, $column_name) {
        switch ($column_name) {
            ...
            case 'functions':
                ...
                $return_string .= ' <a type="button" class="wdt-submit-delete" data-table_id="' . $item['id'] . '" data-table_name="' . $item['title'] . '" data-toggle="tooltip" title="' . __('Delete', 'wpdatatables') . '" href="admin.php?page=wpdatatables-administration&action=delete&table_id=' . $item['id'] . '" rel="' . $item['id'] . '"><i class="zmdi zmdi-delete"></i></a>';
    ...
    function column_title($item) {
        $actions = array(
            ...
            'trash' => '<a class="wdt-submit-delete" title="' . __('Delete', 'wpdatatables') . '" href="admin.php?page=wpdatatables-administration&action=delete&table_id=' . $item['id'] . '" rel="' . $item['id'] . '">' . __('Delete', 'wpdatatables') . '</a>'
        );
