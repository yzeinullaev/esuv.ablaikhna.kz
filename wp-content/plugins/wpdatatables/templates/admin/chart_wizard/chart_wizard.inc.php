            ...
            <div class="card wdt-chart-wizard">
                ...
                <div class="card-body card-padding">
                    ...
                    <ol class="breadcrumb chart-wizard-breadcrumb">
                        <li class="chart_wizard_breadcrumbs_block  step1 active" id="step1"><?php _e('Chart title & type', 'wpdatatables'); ?></li>
                        <li class="chart_wizard_breadcrumbs_block  step2" id="step2"><?php _e('Data source', 'wpdatatables'); ?></li>
                        <li class="chart_wizard_breadcrumbs_block  step3" id="step3"><?php _e('Data range', 'wpdatatables'); ?></li>
                        <li class="chart_wizard_breadcrumbs_block  step4" id="step4"><?php _e('Formatting and preview', 'wpdatatables'); ?></li>
                        <li class="chart_wizard_breadcrumbs_block  step5" id="step5"><?php _e('Save and get shortcode', 'wpdatatables'); ?></li>
                    </ol>
                    ...
                    <div class="row m-t-15 m-b-5 p-l-15 p-r-15">
                        ...
                        <a class="btn btn-default btn-icon-text waves-effect wdt-documentation" data-doc-page="chart_wizard">
