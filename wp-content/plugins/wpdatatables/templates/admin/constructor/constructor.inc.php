                        ...
                        <div class="row m-t-15 m-b-5 p-l-15 p-r-15">
                            <div class="btn-group wdt-constructor-create-buttons pull-right m-l-5" style="display: none;">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li id="wdt-constructor-create-table"><a><?php _e('Open in standard editor', 'wpdatatables'); ?></a></li>
                                    <li id="wdt-constructor-create-table-excel"><a><?php _e('Open in Excel-like editor', 'wpdatatables'); ?></a></li>
                                </ul>
                            </div>
                            <button class="btn btn-primary waves-effect pull-right m-l-5"
                                    disabled="disabled" id="wdt-constructor-next-step"><?php _e('Next ', 'wpdatatables'); ?></button>
                            ...
                            <a class="btn btn-default btn-icon-text waves-effect wdt-documentation" data-doc-page="constructor">
