    ...
    <div class="col-sm-12 p-0">
        ...
        <div class="wdt-constructor-type-selecter-block col-sm-2">
            <div class="card" data-value="source">
                <div class="card-header">
                    ...
                    <img class="img-responsive" src="<?php echo WDT_ASSETS_PATH?>img/constructor/add-from-data-source.png">
                </div>
                <div class="card-body">
        ...
        <div class="wdt-constructor-type-selecter-block col-sm-2">
            <div class="card" data-value="file">
                <div class="card-header">
                    <div class="wdt-constructor-overlay"></div>
                    <img class="img-responsive" src="<?php echo WDT_ASSETS_PATH?>img/constructor/import-data-from-data-source.png">
                </div>
                <div class="card-body">
        ...
        <div class="wdt-constructor-type-selecter-block col-sm-2">
            <div class="card" data-value="wp">
                <div class="card-header">
                    <div class="wdt-constructor-overlay"></div>
                    <img class="img-responsive" src="<?php echo WDT_ASSETS_PATH?>img/constructor/generate-query-to-wordpress-database.png">
                </div>
                <div class="card-body">
        ...
        <div class="wdt-constructor-type-selecter-block col-sm-2">
            <div class="card" data-value="mysql">
                <div class="card-header">
                    <div class="wdt-constructor-overlay"></div>
                    <img class="img-responsive" src="<?php echo WDT_ASSETS_PATH?>img/constructor/generate-query-to-mysql-database.png">
                </div>
                <div class="card-body">
