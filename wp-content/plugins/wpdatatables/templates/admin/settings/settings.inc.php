                ...
                <div class="card-body card-padding p-t-10">
                    ...
                    <div class="row m-t-15 m-b-5 p-l-15 p-r-15">
                        <div class="pull-right">
                            <button class="btn btn-primary waves-effect reset-color-settings" id="reset-color-settings" style="display: none;">
                        ...
                        <a class="btn btn-default btn-icon-text waves-effect wdt-documentation" data-doc-page="settings_page">
