...
<div class="modal fade" id="wdt-add-column-modal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="fg-line">
                                    <input class="form-control input-sm" id="wdt-add-column-column-header" type="text" value="" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="fg-line">
                                    <input type="text" class="form-control input-sm wdt-add-column-default-value" value="">
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-danger btn-icon-text waves-effect" data-toggle="modal" data-target="#wdt-add-column-modal">
