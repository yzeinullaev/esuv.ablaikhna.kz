...
<div class="card column-settings-panel">
    ...
    <div class="card-header ch-alt">
        <h2><?php _e('Column settings', 'wpdatatables'); ?>: <span class="label label-default bgm-gray wdtColumnOrigHeader">Position</span>
        </h2>
        <ul class="actions">
            <li>
    ...
    <div class="card-body card-padding">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 wdt-column-width-block">
                                <h4 class="c-black m-b-20">
                                    ...
                                    <i class="zmdi zmdi-help-outline" data-toggle="tooltip" data-placement="right"
                                       title="You can redefine the visible column header here"></i>
                                </h4>
                                <div class="form-group">
                                    <div class="fg-line">
                            ...
                            <div class="col-sm-6 wdt-column-calc-total-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="m-t-5" id="wdt-column-calc-total-shortcode">
                                        <button class="btn btn-primary btn-xs waves-effect p-5 wdt-copy-shortcode" data-toggle="tooltip" data-placement="top"
        ...
        <div class="row">
            ...
            <div class="col-md-12 p-l-20 p-r-20">
                <button class="btn btn-default btn-icon-text waves-effect wdt-documentation" data-doc-page="column_settings">
