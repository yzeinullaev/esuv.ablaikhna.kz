...
<div class="modal fade" id="wdt-remove-column-modal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
                ...
                <div class="wdt-remove-column-modal-block">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-xs-12">
                            <label for="wdtDeleteColumnSelect" class="col-sm-3 control-label"><strong><?php _e('Remove Column','wpdatatable'); ?></strong></label>
                            <div class="col-sm-9">
                                <div class="fg-line">
                                    <div class="select">
                        ...
                        <div class="form-group col-xs-12 wdt-remove-column-confirmation">
                            <label for="wdtDeleteColumnSelect" class="col-sm-3 control-label"><strong><?php _e('Confirm','wpdatatable'); ?></strong></label>
                            <div class="col-sm-9">
            ...
            <div class="modal-footer">
                <button class="btn btn-danger btn-icon-text waves-effect" data-toggle="modal" data-target="#wdt-remove-column-modal">
