...
<div class="card wdt-table-settings">
    ...
    <div class="card-header wdt-admin-card-header ch-alt ">
        ...
        <button class="btn btn-primary bgm-gray hidden wdt-copy-shortcode" id="wdt-table-id" data-toggle="tooltip" data-placement="top"
                title="<?php _e('Click to copy shortcode', 'wpdatatables'); ?>">[wpdatatable id=23]</button>
        <div class="clear"></div>
    ...
    <div class="card-body card-padding" <?php if (isset($_GET['collapsed'])) { ?> style="display: none" <?php } ?>>
        <div role="tabpanel">
                        ...
                        <div class="col-sm-6 input-path-block hidden">
                            ...
                            <div class="form-group">
                                <div class="fg-line col-sm-9 p-0">
                                    <input type="text" id="wdt-input-url" class="form-control input-sm" placeholder="<?php _e('Paste URL or path, or click Browse to choose', 'wpdatatables'); ?>">
                                </div>
                                <div class="col-sm-3">
                        ...
                        <div class="col-sm-4 m-b-20 wdt-clear-filters-block">
                            ...
                            <div class="hidden" id="wdt-clear-filters-hint">
                                ...
                                <div class="popover-body">
                                    ...
                                    <?php _e('If filter in form is enabled, clear button will be rendered after the last filter.', 'wpdatatables'); ?><br/>
                                    <div class="thumbnail">
                                        <img src="<?php echo WDT_ASSETS_PATH ?>img/hint-pictures/clear_filters_1.png"/>
                                    </div>
                                    <?php _e('Otherwise, clear filter button will be rendered above the table next to "Table Tools" buttons.', 'wpdatatables'); ?><br/><br/>
                                    <div class="thumbnail">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <button class="btn btn-default btn-icon-text waves-effect wdt-documentation" data-doc-page="table_settings">
