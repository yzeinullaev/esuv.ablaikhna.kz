<?php if( isset( $chartObj ) ) { ?>
    <script type='text/javascript'>var editing_chart_data = {render_data: <?php echo json_encode( $chartObj->getRenderData() ); ?>, highcharts_render_data: <?php echo json_encode( $chartObj->getHighchartsRenderData() ); ?>, chartjs_render_data: <?php echo json_encode( $chartObj->getChartJSRenderData() ); ?>, engine: "<?php echo $chartObj->getEngine();?>", type: "<?php echo $chartObj->getType(); ?>", selected_columns: <?php echo json_encode( $chartObj->getSelectedColumns() ) ?>, range_type: "<?php echo $chartObj->getRangeType() ?>"<?php if( $chartObj->getRangeType() == 'picked_range' ){ ?>, row_range: <?php echo json_encode( $chartObj->getRowRange() ); } ?>, title: "<?php echo $chartObj->getTitle(); ?>", follow_filtering: <?php echo (int) $chartObj->getFollowFiltering(); ?>, wpdatatable_id: <?php echo $chartObj->getwpDataTableId(); ?>  };</script>
<?php } ?>
        ...
        <div id="poststuff">
            <div id="post-body" class="metabox-holder">
                <div id="postbox-container-1" class="postbox-container">
                    ...
                    <?php wp_nonce_field('wdt_chart_wizard_nonce', 'wdtNonce'); ?>
                            ...
                            <div class="inside">
                                ...
                                <div class="chart_wizard_breadcrumbs">
                                    ...
                                    <div class="chart_wizard_breadcrumbs_block step4">
                                        <?php _e( 'Formatting and preview', 'wpdatatables' ); ?>
                                    </div>
                                    <span class="chart_wizard_breadcrumbs_separator"> &gt; </span>
                                ...
                                <div class="steps">
                                    ...
                                    <div class="chartWizardStep step1" data-step="step1">
                                        ...
                                        <div style="margin: 10px;">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select id="chart_render_engine">
                                                            ...
                                                            <option value="chartjs" <?php if( !empty( $chart_id ) && ( $chartObj->getEngine() == 'chartjs' ) ){ ?>selected="selected"<?php } ?> >Chart.js</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="charts_type highcharts_charts_type" style="display: none !important;">
                                                    <td colspan="2">
                                                        ...
                                                        <select id="highcharts_chart_type" style="display: none !important;">
                                                            ...
                                                            <option value="highcharts_spline_chart"  data-min_columns="2" data-max_columns="0" data-img-src="<?php echo WDT_ASSETS_PATH?>img/chart_thumbs/highcharts_spline_chart.jpg"><?php _e( 'Spline chart', 'wpdatatables' ); ?></option>
                                                ...
                                                <tr class="charts_type chartjs_charts_type" style="display: none !important;">
                                                    <td colspan="2">
                                                        <label for="chartjs_chart_type"><span><strong><?php _e('Pick a Chart.js chart type','wpdatatables');?></strong></span></label><br/><br/>
                                                        <select id="chartjs_chart_type" style="display: none !important;">
                                                            <option value="chartjs_line_chart"  data-min_columns="2" data-max_columns="0" data-img-src="<?php echo WDT_ASSETS_PATH?>img/chart_thumbs/chartjs_line_chart.jpg"><?php _e( 'Line chart', 'wpdatatables' ); ?></option>
                                                            <option value="chartjs_area_chart"  data-min_columns="2" data-max_columns="0" data-img-src="<?php echo WDT_ASSETS_PATH?>img/chart_thumbs/chartjs_area_chart.jpg"><?php _e( 'Area chart', 'wpdatatables' ); ?></option>
                                                            <option value="chartjs_stacked_area_chart"  data-min_columns="2" data-max_columns="0" data-img-src="<?php echo WDT_ASSETS_PATH?>img/chart_thumbs/chartjs_stacked_area_chart.jpg"><?php _e( 'Stacked area chart', 'wpdatatables' ); ?></option>
                                                            <option value="chartjs_column_chart" data-min_columns="2" data-max_columns="0" data-img-src="<?php echo WDT_ASSETS_PATH?>img/chart_thumbs/chartjs_column_chart.jpg"><?php _e( 'Column chart', 'wpdatatables' ); ?></option>
                                                            <option value="chartjs_radar_chart" data-min_columns="2" data-max_columns="0" data-img-src="<?php echo WDT_ASSETS_PATH?>img/chart_thumbs/chartjs_radar_chart.jpg"><?php _e( 'Radar chart', 'wpdatatables' ); ?></option>
                                                            <option value="chartjs_polar_area_chart" data-min_columns="2" data-max_columns="2" data-img-src="<?php echo WDT_ASSETS_PATH?>img/chart_thumbs/chartjs_polar_area_chart.jpg"><?php _e( 'Polar area chart', 'wpdatatables' ); ?></option>
                                                            <option value="chartjs_pie_chart" data-min_columns="2" data-max_columns="2" data-img-src="<?php echo WDT_ASSETS_PATH?>img/chart_thumbs/chartjs_pie_chart.jpg"><?php _e( 'Pie chart', 'wpdatatables' ); ?></option>
                                                            <option value="chartjs_doughnut_chart" data-min_columns="2" data-max_columns="2" data-img-src="<?php echo WDT_ASSETS_PATH?>img/chart_thumbs/chartjs_doughnut_chart.jpg"><?php _e( 'Doughnut chart', 'wpdatatables' ); ?></option>
                                                            <option value="chartjs_bubble_chart" data-min_columns="4" data-max_columns="4" data-img-src="<?php echo WDT_ASSETS_PATH?>img/chart_thumbs/chartjs_bubble_chart.jpg"><?php _e( 'Bubble chart', 'wpdatatables' ); ?></option>
                                                        </select>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <div class="chartWizardStep step4" data-step="step4" style="display: none">
                                        <div style="margin: 10px; width: 50%;">
                                            ...
                                            <!--CHART-->
                                            <div id="normal-sortables" class="meta-box-sortables ui-sortable">
                                                <div id="chart-container-tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all settings">
                                                    <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all settings">
                                                        <li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active chart-container"><a href="#chart-container-tabs-1" class="ui-tabs-anchor chart-container"><?php _e('Chart','wpdatatables'); ?></a></li>
                                                        <li class="ui-state-default ui-corner-top chart-container series"><a href="#chart-container-tabs-2" class="ui-tabs-anchor chart-container"><?php _e('Series','wpdatatables'); ?></a></li>
                                                        <li class="ui-state-default ui-corner-top chart-container axes"><a href="#chart-container-tabs-3" class="ui-tabs-anchor chart-container"><?php _e('Axes','wpdatatables'); ?></a></li>
                                                        <li class="ui-state-default ui-corner-top chart-container title"><a href="#chart-container-tabs-4" class="ui-tabs-anchor chart-container"><?php _e('Title','wpdatatables'); ?></a></li>
                                                        <li class="ui-state-default ui-corner-top chart-container tooltip"><a href="#chart-container-tabs-5" class="ui-tabs-anchor chart-container"><?php _e('Tooltip','wpdatatables'); ?></a></li>
                                                        <li class="ui-state-default ui-corner-top chart-container legend"><a href="#chart-container-tabs-6" class="ui-tabs-anchor chart-container"><?php _e('Legend','wpdatatables'); ?></a></li>
                                                        <li class="ui-state-default ui-corner-top chart-container highcharts"><a href="#chart-container-tabs-7" class="ui-tabs-anchor chart-container"><?php _e('Exporting','wpdatatables'); ?></a></li>
                                                        <li class="ui-state-default ui-corner-top chart-container highcharts"><a href="#chart-container-tabs-8" class="ui-tabs-anchor chart-container"><?php _e('Credits','wpdatatables'); ?></a></li>
                                                    </ul>
                                                    <div id="chart-container-tabs-1" class="ui-tabs-panel ui-widget-content ui-corner-bottom chart-container chart-options-container">
                                                        <div class="inside">
                                                            <table class="form-table wpDataTables">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="number" min="0" id="chart_width" value="0" readonly="readonly" style="margin-bottom: 5px" /><br/>
                                                                        <input type="checkbox" id="chart_responsive_width" checked="checked" /> <?php _e('Responsive width','wpdatatables');?><br/>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="number" min="0" id="chart_height" value="400" /><br/>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="vertical-align: top;">
                                                                ...
                                                                <tr id="border_width_row">
                                                                    ...
                                                                    <td>
                                                                        <input type="number" min="0" name="border_width" id="border_width" value="0">
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr id="border_radius_row">
                                                                    ...
                                                                    <td>
                                                                        <input type="number" min="0" name="border_radius" id="border_radius" value="0">
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr class="google highcharts" id="plot_background_color_row">
                                                                    <td>
                                                                ...
                                                                <tr class="google highcharts" id="plot_border_width_row">
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <input type="number" min="0" name="plot_border_width" id="plot_border_width" value="0">
                                                                    </td>
                                                                </tr>
                                                                <tr class="google highcharts" id="plot_border_color_row">
                                                                    <td>
                                                                ...
                                                                <tr class="google chartjs" id="font_size_row">
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <input type="number" min="0" name="font_size" id="font_size">
                                                                    </td>
                                                                </tr>
                                                                <tr class="google chartjs" id="font_name_row">
                                                                    <td>
                                                                ...
                                                                <tr class="chartjs" id="font_style_row">
                                                                    <td>
                                                                        <label for="font_style"><span><strong><?php _e('Font style','wpdatatables');?></strong></span></label><br/>
                                                                        <span class="description"><small><?php _e('The default font style for all text in the chart','wpdatatables');?>.</small></span>
                                                                    </td>
                                                                    <td>
                                                                ...
                                                                <tr class="chartjs" id="font_color_row">
                                                                    <td>
                                                                        <label for="font_color"><span><strong><?php _e('Font color','wpdatatables');?></strong></span></label><br/>
                                                                        <span class="description"><small><?php _e('The default font color for all text in the chart','wpdatatables');?>.</small></span>
                                                                    </td>
                                                                    <td>
                                                                        <div id="font_color_container">
                                                                            <input type ="text" class="font_color">
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <div id="chart-container-tabs-2" class="ui-tabs-panel ui-widget-content ui-corner-bottom chart-container chart-options-container">
                                                        <div class="inside">
                                                            <table class="form-table wpDataTables">
                                                                <tbody>
                                                                <tr>
                                                                ...
                                                                <tr class="chartjs google" id="curve_type_row">
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <input type="checkbox" id="curve_type" checked="checked"/><label for="curve_type"><?php _e('Check for smoothed lines','wpdatatables'); ?></label>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                    ...
                                                    <div id="chart-container-tabs-3" class="ui-tabs-panel ui-widget-content ui-corner-bottom chart-container chart-options-container">
                                                        <div class="inside">
                                                            <table class="form-table wpDataTables">
                                                                <tbody>
                                                                <tr id="show_grid_row">
                                                                ...
                                                                <tr class="google highcharts" id="horizontal_axis_crosshair_row">
                                                                    <td>
                                                                ...
                                                                <tr class="google highcharts" id="vertical_axis_crosshair_row">
                                                                    <td>
                                                                ...
                                                                <tr id="vertical_axis_min_row">
                                                                    ...
                                                                    <td>
                                                                        <input type="number" min="0" id="vertical_axis_min" value="" />
                                                                    </td>
                                                                </tr>
                                                                <tr id="vertical_axis_max_row">
                                                                    ...
                                                                    <td>
                                                                        <input type="number" min="0" id="vertical_axis_max" value="" />
                                                                    </td>
                                                                </tr>
                                                                <tr class="google highcharts" id="inverted_row">
                                                                    <td>
                                                    ...
                                                    <div id="chart-container-tabs-4" class="ui-tabs-panel ui-widget-content ui-corner-bottom chart-container chart-options-container">
                                                        <div class="inside">
                                                            <table class="form-table wpDataTables">
                                                                <tbody>
                                                                ...
                                                                <tr class="google highcharts" id="title_floating_row">
                                                                    <td>
                                                                ...
                                                                <tr class="chartjs">
                                                                    <td>
                                                                        <label for="title_position"><span><strong><?php _e('Title position','wpdatatables');?></strong></span></label><br/>
                                                                        <span class="description"><small><?php _e('	Position of the title. Possible values are \'top\', \'left\', \'bottom\' and \'right\'','wpdatatables');?>.</small></span>
                                                                    </td>
                                                                    <td>
                                                                        <select name="title_position" id="title_position">
                                                                ...
                                                                <tr class="chartjs" id="title_font_name_row">
                                                                    <td>
                                                                        <label for="title_font_name"><span><strong><?php _e('Title font name','wpdatatables');?></strong></span></label><br/>
                                                                        <span class="description"><small><?php _e('The default font face for text in the title','wpdatatables');?>.</small></span>
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" name="title_font_name" id="title_font_name" value="Arial">
                                                                    </td>
                                                                </tr>
                                                                <tr class="chartjs" id="title_font_style_row">
                                                                    <td>
                                                                        <label for="title_font_style"><span><strong><?php _e('Title font style','wpdatatables');?></strong></span></label><br/>
                                                                        <span class="description"><small><?php _e('The default font style for text in the title','wpdatatables');?>.</small></span>
                                                                    </td>
                                                                    <td>
                                                                        <select name="title_font_style" id="title_font_style">
                                                                ...
                                                                <tr class="chartjs" id="title_font_color_row">
                                                                    <td>
                                                                        <label for="title_font_color"><span><strong><?php _e('Title font color','wpdatatables');?></strong></span></label><br/>
                                                                        <span class="description"><small><?php _e('The default font color for text in the title','wpdatatables');?>.</small></span>
                                                                    </td>
                                                                    <td>
                                                                        <div id="title_font_color_container">
                                                                            <input type ="text" class="title_font_color">
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr class="highcharts">
                                                    ...
                                                    <div id="chart-container-tabs-5" class="ui-tabs-panel ui-widget-content ui-corner-bottom chart-container chart-options-container">
                                                        <div class="inside">
                                                            <table class="form-table wpDataTables">
                                                                <tbody>
                                                                <tr id="tooltip_enabled_row">
                                                                    ...
                                                                    <td>
                                                                        <input type="checkbox" id="tooltip_enabled" checked="checked" /> <label for="tooltip_enabled"><?php _e('Show tooltip','wpdatatables'); ?></label>
                                                                    </td>
                                                                </tr>
                                                                <tr class="highcharts chartjs">
                                                                    <td>
                                                                ...
                                                                <tr class="highcharts">
                                                                    ...
                                                                    <td>
                                                                        <input type="number" min="0" name="tooltip_border_width" id="tooltip_border_width" value="1">
                                                                    </td>
                                                                </tr>
                                                                <tr class="highcharts">
                                                                    <td>
                                                                ...
                                                                <tr class="highcharts chartjs">
                                                                    ...
                                                                    <td>
                                                                        <input type="number" min="0" name="tooltip_border_radius" id="tooltip_border_radius" value="3">
                                                                    </td>
                                                                </tr>
                                                                <tr class="highcharts chartjs">
                                                                    <td>
                                                    ...
                                                    <div id="chart-container-tabs-6" class="ui-tabs-panel ui-widget-content ui-corner-bottom chart-container chart-options-container">
                                                        <div class="inside">
                                                            <table class="form-table wpDataTables">
                                                                <tbody>
                                                                <tr class="highcharts chartjs">
                                                                ...
                                                                <tr class="google highcharts" id="legend_vertical_align_row">
                                                                    <td>
                                                                ...
                                                                <tr class="highcharts">
                                                                    ...
                                                                    <td>
                                                                        <input type="number" min="0" name="legend_border_width" id="legend_border_width" value="0">
                                                                    </td>
                                                                </tr>
                                                                <tr class="highcharts">
                                                                    <td>
                                                                ...
                                                                <tr class="highcharts">
                                                                    ...
                                                                    <td>
                                                                        <input type="number" min="0" name="legend_border_radius" id="legend_border_radius" value="0">
                                                                    </td>
                                                                </tr>
                                                                <tr class="chartjs" id="legend_position_row">
                                                                    <td>
                                                                        <label for="legend_position_cjs"><span><strong><?php _e('Legend position','wpdatatables');?></strong></span></label><br/>
                                                                        <span class="description"><small><?php _e('Position of the legend. Possible values are \'top\', \'left\', \'bottom\' and \'right\'','wpdatatables');?>.</small></span>
                                                                    </td>
                                                                    <td>
                                                                        <select name="legend_position_cjs" id="legend_position_cjs">
                                                                            <option selected="selected" value="top">Top</option>
                                                                            <option value="left">Left</option>
                                                                            <option value="bottom">Bottom</option>
                                                                            <option value="right">Right</option>
                                                    ...
                                                    <div id="chart-container-tabs-7" class="ui-tabs-panel ui-widget-content ui-corner-bottom chart-container chart-options-container">
                                                        <div class="inside">
                                                            <table class="form-table wpDataTables">
                                                                <tbody>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <span class="description"><small><?php _e('Add data labels to improve readability of the exported chart','wpdatatables');?>.</small></span>
                                                                    </td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="number" min="0" name="exporting_width" id="exporting_width">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                    ...
                                                    <div id="chart-container-tabs-8" class="ui-tabs-panel ui-widget-content ui-corner-bottom chart-container chart-options-container">
                                                        <div class="inside">
                                                            <table class="form-table wpDataTables">
                                                                <tbody>
                                                                <tr>
                                        ...
                                        <div class="chart-preview-container">
                                            <h3><?php _e( 'Chart preview','wpdatatables' ); ?></h3>
